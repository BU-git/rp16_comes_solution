...
public class ShiftRestController {
    ...
    @ResponseStatus(HttpStatus.OK)
    public void editShift(@PathVariable final int shift_id, @Valid @RequestBody Shift inputShift, @PathVariable("user_id") final int user_id) throws ShiftNoExistsException, ShiftOverlapsException {
